...
#define TH0_WAIT 11
#define IDLE 1
#define TH0_PPS_COMMIT 12
#define TH1_PPS_COMMIT 13
#define TH1_EVENT 9
#define TH0_EVENT 4
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0xAAAA, 0x5555, 0xFFFF, 0x3333, 0xC0FF
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    ...
    {{0x2E739A05,0x20010002,0x80000080},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739A03,0x24000104,0x80000080},{0x2E739E04,0x20010002,0x80000040}},
    {{0x1F0AB407,0x2401010A,0x80000040},{0x3E739C08,0x00000000,0x80000100}},
    {{0x1E739E01,0x00000100,0x80000000},{0x3E739C0C,0x20000100,0x80100040}},
    {{0x3E739C06,0x00000000,0x80000100},{0x1F0AB402,0x2001010A,0x80000040}},
    {{0x1E73DA0B,0x00000108,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x2E739A05,0x20010002,0x80000080},{0x1E739E09,0x24000104,0x80000040}},
    {{0x1E73DA0A,0x04000108,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x3E739C0D,0x24000100,0x80100040},{0x1E739E01,0x00000100,0x80000000}},
    {{0x1E739A03,0x24000104,0x80000080},{0x1E739E01,0x00000100,0x80000000}},
    {{0x2E739A05,0x20010002,0x80000080},{0x1E739E01,0x00000100,0x80000000}},
...
uint32_t CyFxGpifRegValue[]  = {
    0x80009301,  /*  CY_U3P_PIB_GPIF_CONFIG */
    ...
    0x00000004,  /*  CY_U3P_PIB_GPIF_CTRL_COMP_MASK */
